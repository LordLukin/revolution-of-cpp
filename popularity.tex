...
\slide{TIOBE}{
    ...
    \centering 
    \includegraphics<2>[height=0.7\paperheight]{tiobe-graph} %TODO: Wyszarzyć w paincie inne języki
    \includegraphics<3>[height=0.7\paperheight]{tiobe-array} % TODO: zaznaczyć gdzie jest C++  
}
...
\slide{PYPL}{
    ...
    \centering 
    \includegraphics<2>[height=0.8\paperheight]{pypl-graph} %TODO: strzałka na C++
    \includegraphics<3>[height=0.8\paperheight]{pypl-array}
}
