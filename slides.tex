...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{0.7\textwidth}
      ...
      \includegraphics[height=50pt]{css3-logo} \\
      \includegraphics[height=50pt]{blank}
      \includegraphics[height=60pt]{blank} \\
      \includegraphics[height=80pt]{blank}
      \includegraphics[height=65pt]{blank}
  \end{columns}
\end{frame}
