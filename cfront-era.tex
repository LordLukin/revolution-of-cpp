...
%		\only<1-4>{``C++ is a general purpose programming language designed to make programming more enjoyable for the serious programmer''}
%        \only<5->{\st{``C++ is a general purpose programming language designed to make programming more enjoyable for the serious programmer''}}
%	\end{alertblock}
...
\timeSlide{Cfront 2.0}{
    ...
    \begin{enumerate}
        ...
        \item type-safe linkage (name mangling)
...
\slide{Cfront - summary}{
	\itemstep{
		...
		\item New approach to exceptions was impossible to add
	}
}