...
\slide{How many book covers are in my presentation?}{
    \pause
    \centering
    \includegraphics[height=0.4\paperheight]{writing-device-drivers-with-js}
    \includegraphics[height=0.4\paperheight]{bloated-jabbascript-frameworks}
    \includegraphics[height=0.4\paperheight]{changing-stuff-and-seeing-what-happens}
    \includegraphics[height=0.4\paperheight]{trying-stuff-until-it-works} \\
    \includegraphics[height=0.4\paperheight]{it-depends}
    \includegraphics[height=0.4\paperheight]{copying-and-pasting-from-stack-overflow}
    \includegraphics[height=0.4\paperheight]{effective-modern-cpp}
    \includegraphics[height=0.4\paperheight]{the-cpp-programming-language}
}
